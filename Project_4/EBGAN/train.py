...
from models.discriminator import EBGAN_Discriminator
from models.generator import EBGAN_Generator

from utils import train_networks, load_data

parser = argparse.ArgumentParser()
parser.add_argument("--arch", default="ebgan")
...
def main():
    ...
    discriminator = EBGAN_Discriminator()
